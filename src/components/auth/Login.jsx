...
const Login = ({ onSwitchToRegister, onSwitchToForgot }) => {
  ...
  const handleSubmit = () => {
    if (validateForm()) {
      ...
      alert(`${userType === 'user' ? 'User' : 'Lawyer'} Login successful!`);
    }
  };
      ...
      <div className="space-y-5">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-3 px-4 border-2 border-gray-300 rounded-md flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
          >
